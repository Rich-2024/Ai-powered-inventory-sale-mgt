...
<div class="container mt-0">
  ...
  <p class="text-muted mt-2">We appreciate your business. Keep the receipt for reference.</p>
      ...
      <form id="saleForm" action="{{ route('admin.sales.store') }}" method="POST" class="row g-3 mt-3">
        ...
        <div class="col-md-6">
          <label class="form-label fw-semibold"><i class="bi bi-pie-chart"></i> In-Stock Qty</label>
          <input type="text" id="stock_display" class="form-control bg-light" readonly placeholder="Choose product">
        </div>

        <div class="col-md-6">
          <label class="form-label fw-semibold"><i class="bi bi-cash-stack"></i> Reserved Price (UGX)</label>
...
<script>
  ...
  const amountInput = document.getElementById('amount_sold');
